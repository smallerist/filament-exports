...
```bash
composer require smallerid/filament-exports
```
...
```css
@import '../../vendor/smallerid/filament-exports/resources/css/filament-export.css';
```

2. Import `filament-export.js` in your `/resources/app.js`

```js
import '../../vendor/smallerid/filament-exports/resources/js/filament-export.js';
```
...
```bash
php artisan vendor:publish --provider="SmallerId\FilamentExport\FilamentExportServiceProvider" --tag="config"
```
...
```bash
php artisan vendor:publish --provider="SmallerId\FilamentExport\FilamentExportServiceProvider" --tag="views"
```
